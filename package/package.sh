...
if [ -f /etc/fedora-release ]; then
    ...
    sudo dnf install -y rpm-build ninja-build cmake gcc-c++ eigen3-devel suitesparse-devel libpng-devel mesa-libGL-devel gmsh-devel glfw-devel spectra-devel glm-devel
